...
HIDDEN_IMPORTS = [
    ...
    "app.core.invariants",
    "app.core.agent_base_instruction",
    "app.core.identity_principle",
    "app.core.tool_runtime",
    "app.core.tool_runtime.executor",
    "app.core.tool_runtime.approval",
    "app.core.tool_runtime.risk_engine",
    "app.core.tool_runtime.strategy",
    "app.core.tool_runtime.preapproval",
    "app.core.tool_runtime.guidance",
    ...
    "app.core.agent_runtime.completion",
    "app.core.agent_runtime.completion.rules",
    "app.core.agent_runtime.completion.tool_check",
    "app.core.agent_runtime.completion.pipeline",
    "app.core.agent_runtime.completion.models",
    ...
    "app.core.verification.models",
    "app.core.verification.strategies",
    "app.core.verification.verifier",
    "app.core.verification.loop",
    "app.core.pagination",
    "app.core.errors",
