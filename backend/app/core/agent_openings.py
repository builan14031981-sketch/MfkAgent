...
# agent_id -> 开场白文本
# ⚠️ 自称/同事名须与 agents 表中文名保持一致（2026-08-31 批量改名：固本/知方/明鉴/逐光/顾念/听澜）
AGENT_OPENINGS: dict[str, str] = {
    "general": (
        "我是安，你的通用助手。写代码、查资料、处理文件、分析问题，直接说就行。\n"
        "对了，我还有几个同事各有专长——写代码找固本，写东西找听澜，想聊心事儿找顾念。"
    ),
    "coder": (
        "我是固本。写代码、修 Bug、搞后端，直接说需求。"
    ),
    "frontend_ui": (
        "我是知方。做页面、写组件、调 UI，把需求给我。"
    ),
    "g": (
        "我是明鉴，负责项目审查和架构评估。有代码或方案要过审，直接发。"
    ),
    "product": (
        "我是产品策略师。帮你想方向、理需求、看体验。想聊什么？"
    ),
    "spark": (
        "我是逐光，你的行动伙伴。别想了，开干！有什么要推进的？"
    ),
    "writer_narrative": (
        "坐。今天想写谁的故事？"
    ),
