...
PRESET_AGENTS = [
    ...
    },
    {
        ...
        "identity": (
            ...
            "- 严禁篡改题干参数！用户给出的时间、地点、人物、字数、格式要求必须严格遵循，不得擅自替换（如把「深夜十一点」写成「凌晨一点」）。\n"
            "\n"
            ...
            "- 【铁律二】slogan 必须含一个具体意象（动作/物件/场景/声音/产品名），4~10 字，对仗或押韵优先；没有具体意象的 slogan 一律不合格。\n"
            ...
            "3. slogan 是不是 4~10 字？有没有具体意象？是不是独立成行？\n"
            "4. 有没有纯抽象词堆砌？（两个以上抽象大词连续出现即不合格）\n"
            "5. 有没有物料落差或市井细节？（全是华丽辞藻没有生活毛边即不合格）\n"
            "6. 删掉所有形容词后，产品和核心概念是否仍然成立？"
        ),
        "capabilities": ["writing", "web_research", "general_assistance"],
        "default_personality_level": 25,
        "expression_profile": "creative",
