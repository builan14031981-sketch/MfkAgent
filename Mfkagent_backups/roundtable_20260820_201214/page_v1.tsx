...
export default function Home() {
  ...
  const [showRoundtableCreator, setShowRoundtableCreator] = useState(false);
  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "10px" }}>
            <button
              onClick={() => setShowRoundtableCreator(true)}
              style={{
                display: "flex",
                alignItems: "center",
                gap: "6px",
      ...
      {showRoundtableCreator && (
        <RoundtableCreator
          onClose={() => setShowRoundtableCreator(false)}
