...
export function RoundtableCreator({
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // 主持人优先选 general (安)，若无则选第一个席位
      const hasGeneral = selectedAgentIds.includes("general");
      const moderatorId = hasGeneral ? "general" : selectedAgentIds[0];
      ...
      const chatTitle = content.trim() ? content.slice(0, 40) : "圆桌会议室";
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="输入开场讨论主题，或直接留空点击下方按钮进入会议室..."
              rows={2}
              style={{
                width: "100%",
                padding: "9px 12px",
            ...
            style={{
              ...
              color:
                selectedAgentIds.length >= 2
                  ...
                  : "var(--text-level-4)",
              cursor:
                selectedAgentIds.length >= 2 && !creating
                  ? "pointer"
                  : "not-allowed",
              fontSize: "13px",
              fontWeight: 600,
